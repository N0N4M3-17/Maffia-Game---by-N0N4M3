...
| Test automation / quality gate | **In progress** | 15% | Static checks exist and executable JUnit coverage now covers vote majority, ties, abstentions, and plurality helpers; broader role, phase, night-resolution, win-condition, authorization, and API smoke tests remain. |
...
- [ ] Create automated unit tests for role assignment, phase transitions, night resolution, vote resolution, win conditions, and authorization.
  - [x] Add the first JUnit rule tests for vote resolution helpers.
